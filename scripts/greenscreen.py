...
for x in range(0, len(bgimages)):
    ...
    commandis = 'convert'
    commandis = "convert " + folder + "sourcebg/" + bgimage + "  -resize " + str(width) + "x" + str(
        height) + " " + folder + "background/" + bgimage
...
while running == True:
    ...
    print (commandis)
    os.system(
        '/usr/bin/convert -limit thread 4 ' + folder + 'imagecam.png -fuzz ' + fuzzpercent + ' -transparent "#' + rgbnum + ' " ' + folder + 'imagecamt.png')
